...
class Bird {
     ...
     * @param {number} [timeout=0] Timeout for axios in miliseconds
     * @memberof Bird
     */
    ...
    this.request.interceptors.request.use(
      axiosConfig => {
        Object.assign(axiosConfig.headers, {
          Authorization: `Bird ${this.accessToken}`
        });
        return axiosConfig;
      },
  ...
  async stopRide(scooter, ride) {
    try {
      ...
      let response = await this.request({
        ...
        data: {
          photo_url:
            'https://s3.amazonaws.com/bird-uploads-production/ride-photos/b64bacac-f2d6-40ad-85ba-ccb046264904.png',
          ride_id: ride.bird['ride_id']
        },
        responseType: 'json'
      });
