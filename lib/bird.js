...
class Bird {
    constructor() {
        this.request = axios.create({
            ...
            timeout: '0', //define a default timeout. 0 means there is no timeout
            headers: {
    ...
    /**
     * Set's the timeout for this axios object
     *
     * @param {String} timeout desired timeout in ms (milliseconds) 
     * @memberof Bird
     */
    setReqTimeout(timeout) {
